...
def post_list(request):
    posts = Post.objects.filter(done=False)
    return render(request, 'blog/post_list.html', {'posts': posts})

def post_list_done(request):
    posts = Post.objects.filter(done=True)
    return render(request, 'blog/post_list_done.html', {'posts': posts})
